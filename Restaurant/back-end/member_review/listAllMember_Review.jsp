	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<table id="table-1">
				<tr>
					<td>
						<h3 style="margin-bottom: 0;">查看所有評價紀錄</h3>
					</td>
				</tr>
			</table>
			<br>
			...
			<table class="table table-hover" style="width: 100%; font-size: 90%;">
				...
				<tbody>
					<c:forEach var="member_reviewVO" items="${list}"
						...
						<tr>
							<td style="text-align: center;">${member_reviewVO.review_no}</td>
							<td style="text-align: center;">${member_reviewVO.meal_order_no}</td>
							<td style="text-align: center;">${member_reviewVO.mem_review_con}</td>
							<td style="text-align: center;"><fmt:formatDate
									value="${member_reviewVO.review_date}" pattern="yyyy-MM-dd" /></td>
							...
							<td>
								<FORM METHOD="post"
									...
									<input type="submit" value="刪除" id="delete"
										...
										value="${member_reviewVO.review_no}"> <input

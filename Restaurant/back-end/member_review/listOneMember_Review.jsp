	...
	<div class="wrapper">
		...
		<div id="content">
									...
									<c:choose>
										...
										<c:otherwise>
											<div id="topLogOut"
												...
												onMouseOver="this.style.color='#fff'; this.style.background='#000';"
												onMouseOut="this.style.color='#ccc'; this.style.background='#424242';">
												<a href="<%=request.getContextPath()%>/back-end/emp/emp.do?action=logout">Log out</a>
											</div>
										</c:otherwise>
									</c:choose>
								</li>
			...
			<table class="table table-hover" style="width: 100%; font-size: 90%;">
				...
				<tbody>
					<tr>
						<td style="text-align: center;"><%=member_reviewVO.getReview_no()%></td>
						<td style="text-align: center;"><%=member_reviewVO.getMeal_order_no()%></td>
						<td style="text-align: center;"><%=member_reviewVO.getMem_review_con()%></td>
						<td style="text-align: center;"><%=member_reviewVO.getReview_date()%></td>
						<td style="text-align: center;">
							<FORM METHOD="post"
								ACTION="<%=request.getContextPath()%>/back-end/member_review/forwarded"
								style="margin-bottom: 0px;">
								<input type="submit" value="未通過" id="revise"
									...
									type="hidden" name="action" value="getOneForReviewFailed">
							</FORM>
						</td>
						<td style="text-align: center;">
							<FORM METHOD="post"
								...
								<input type="submit" value="通過" id="delete"
									...
									type="hidden" name="review_no"
									value="<%=member_reviewVO.getReview_no()%>"> <input
									type="hidden" name="action" value="getOneForReviewSuccess">
							</FORM>
						</td>
					</tr>
				</tbody>

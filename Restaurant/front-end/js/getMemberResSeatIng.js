...
//		// which
//		// one judgment
//		url: ajaxURL + "/res_order/ResOrderServlet.do?action=get_Member_Res_Seat_Ing",
//		type: "post",
//		
//		// synchronize is true
//		async: false,
...
//			$("<th>").text("修改座位").appendTo(row);
//			$("<th>").text("取消訂位").appendTo(row);
//			
